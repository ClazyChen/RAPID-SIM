export module rapid.SongPacketGenerator;
...
class SongPacketGenerator {
    TunedZipfDistribution<K, 2, 1000000, 1, 10> m_zipf; // to control the key
...
public:
    ...
    SongPacketGenerator() = default;
    SongPacketGenerator(double lambda, double alpha = 1.01)
        : m_zipf(alpha)
        , m_geo(lambda)
    {
    }
